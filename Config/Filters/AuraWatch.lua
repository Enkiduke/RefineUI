...
R.RaidBuffs = {
	DRUID   = {
		...
		{ 155777, { 0.4, 0.9, 0.4 } }, -- Rejuvenation (Germination)
	},
	EVOKER  = {
		-- Preservation
		{ 355941, { 0.20, 0.58, 0.50 } }, -- Dream Breath
		{ 363502, { 0.26, 0.73, 0.63 } }, -- Dream Flight
	...
	MONK    = {
		...
		{ 115175, { 0.7, 0.4, 0 } }, -- Soothing Mist
	...
	WARRIOR = {
		{ 3411, { 0.89, 0.1, 0.1 } }, -- Intervene
	},
	WARLOCK = {
		{ 20707, { 0.7, 0.32, 0.75 } }, -- Soulstone
	},
	ALL     = {
		{ 23333, { 1, 0, 0 } }, -- Warsong flag, Horde
		{ 23335, { 0, 0, 1 } }, -- Warsong flag, Alliance
		{ 34976, { 1, 0, 0 } }, -- Netherstorm Flag
	},
}
...
-- 	tinsert(R.RaidBuffs["ALL"], { 284402, "RIGHT", { 1, 0, 0 }, true }) -- Vampiric Touch (Don't dispel)
-- 	tinsert(R.RaidBuffs["ALL"], { 30108, "RIGHT", { 1, 0, 0 }, true }) -- Unstable Affliction (Don't dispel)

-- 	for spell, prio in pairs(PvPDebuffs) do
-- 		R.RaidDebuffs[spell] = prio
-- 	end
-- end

R.RaidDebuffsReverse = {
	--[spellID] = true,			-- Spell name
}
...
-- 	R.RaidDebuffs[SpellName(spell)] = 3
-- end

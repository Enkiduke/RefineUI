...
local function SyncNameplateCastAlphaState(castBar, unitFrame, unit, forceRefresh)
    ...
    elseif forceRefresh and RefineUI.UpdateTarget then
        RefineUI:UpdateTarget(unitFrame)
    end
end
...
function RefineUI:StyleNameplateCastBar(castBar)
    ...
    castBar.UpdateUnitEvents = function(self, unit)
        ...
        SyncNameplateCastAlphaState(self, unitFrame, resolvedUnit, true)
    end
    ...
    eventFrame:SetScript("OnEvent", function(evFrame, event, unit)
         ...
         SyncNameplateCastAlphaState(castBar, unitFrame, unit, false)

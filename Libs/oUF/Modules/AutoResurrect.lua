...
-- if C.raidframe.plugins_auto_resurrection ~= true or C.misc.click_cast == true or R.class == "DEMONHUNTER" or R.class == "HUNTER" or R.class == "MAGE" or R.class == "ROGUE" or R.class == "WARRIOR" then return end
do return end
----------------------------------------------------------------------------------------

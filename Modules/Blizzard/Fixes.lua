...
do
    ...
    if settingsPanel then
        settingsPanel.TransitionBackOpeningPanel = _G.HideUIPanel
    end
end
...
-- ----------------------------------------------------------------------------------------
-- --	Disable MicroMenu button pulse flash
-- ----------------------------------------------------------------------------------------
-- g_flashingMicroButtons = {} -- Initialize the table to store flashing buttons

-- function MicroButtonPulse(self, duration)
--     -- Commenting out the pulse flash functionality
...
--     -- Stop any existing flash effects
...
f:SetScript("OnEvent", function(__, event, arg1, arg2, arg3, arg4)
	if event == "UNIT_SPELLCAST_SENT" then
        if(arg4 == 372608 or 372610 or 361584)then

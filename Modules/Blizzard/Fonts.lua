...
frame:SetScript("OnEvent", function(_, _, addon)
	...
	local NORMAL = C.media.normalFont
	...
	SetFont(GameTooltipHeader, NORMAL, C.font.tooltip_header_size, nil, nil, nil, nil, 0, 0, 0, 1, -1)
	SetFont(Tooltip_Med, NORMAL, C.font.tooltip_size, nil, nil, nil, nil, 0, 0, 0, 1, -1)
	...
	SetFont(ChatBubbleFont, NORMAL, C.font.bubble_size, "OUTLINE", nil, nil, nil, 0, 0, 0, 1, -1)
	...
	SetFont(ObjectiveTrackerHeaderFont, NORMAL, 16, "OUTLINE") -- Quest title and objectives
	SetFont(ObjectiveTrackerLineFont, NORMAL, 14, "OUTLINE") -- Quest tracker
	SetFont(ObjectiveTrackerFont12, NORMAL, 16, "OUTLINE") -- Quest title and objectives
	SetFont(ObjectiveTrackerFont14, NORMAL, 14, "OUTLINE") -- Quest tracker
end)
